...
def send_mail_function(): # defined function to send mail post fire detection using threading
    ...
    recipientmail = "archishman02.c@gmail.com" # recipients mail
    ...
    try:
        ...
        server.ehlo()
        server.starttls()
        server.login("iotbioece@gmail.com", 'ccgszzkukpksxtkb') # Senders mail ID and password
        server.sendmail('archishman02.c@gmail.com', recipientmail, "Warning fire accident has been reported") # recipients mail with mail message
